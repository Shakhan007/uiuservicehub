...
while ($row = $result1->fetch_assoc()) {
    ...
    if($amount > 1499)
    {
        $sql4 = "INSERT INTO `shuttle_payment`(`first_name`, `last_name`, `student_id`, `email`, `phone_number`, `payment_number`, `amount`, `route_name`, `route_id`) VALUES ('$first_name','$last_name','$s_id','$email','$phone','$p_number','$amount','$bus_name','$rout_id')";
