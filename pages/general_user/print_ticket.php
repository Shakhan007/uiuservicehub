<?php
  include '../sqlCommands/connectDb.php';
   session_start();
    ...
    $r = "SELECT * FROM `shuttle_payment` WHERE `email` = '$email'";
...
<body>
    ...
    <?php
     ...
     else
     {
        ...
        <div class="card__info">
            ...
            <div class="card__name"><?php echo $s_id?></div><br>
            <div class="card__name"><?php echo $phone?></div><br>
    ...
    <button id="btnPrint" class="hidden-print btn success">Print</button>
    <?php
     }
    ?>
</body>
